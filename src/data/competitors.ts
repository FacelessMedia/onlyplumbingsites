...
export const competitors: Competitor[] = [
  {
    ...
    cons: [
      ...
      "Cookie-cutter website templates shared across clients",
    ...
    features: [
      ...
      { feature: "Custom website design (no templates)", us: true, them: "Varies" },
  ...
  },
  {
    ...
    features: [
      ...
      { feature: "Custom website (no templates)", us: true, them: false },
